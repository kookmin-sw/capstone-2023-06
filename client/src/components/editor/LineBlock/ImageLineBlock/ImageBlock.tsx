...
import { Refer, addRefer, checkRefers, newImage, removeImage, removeRefer, updateRefers } from "../../../../modules/images";
...
const ImageBlock = ({ id } : { id: string }) => {
    ...
    return (
        ...
        >
            <input ref={fileInputRef} type="file" name="userfile" onChange={handleAddImages} style={{display: 'none'}}/>
            {
                showImage !== '' &&
                <FullImage
                ref={imgRef}
